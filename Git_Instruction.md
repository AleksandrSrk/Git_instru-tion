...
### 12.2 Слияние ветdddок. 
Чтобы произвести слияние веток репозитория, необходимо перейти в ветку, в котdddорую хотим произвести слияние командой `git checkout имя_ветки`, и ввести в терминале команду `git merge имя_ветки_которую_добавляем`. 
> Важно! Перед слиянием веток все изменения в файле должны быть закоммdddичены.